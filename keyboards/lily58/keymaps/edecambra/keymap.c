 ...
 */
 ...
 [_QWERTY] = LAYOUT(
    ...
    KC_LCTL,  KC_Z,MT(MOD_LGUI,KC_X),KC_C,  KC_V,KC_B,  KC_MUTE,  LALT(LCTL(KC_DEL)),  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RCTL,
...
[_NUMSYM] = LAYOUT(
  ...
  KC_GRV,  _______,   _______,  C(S(KC_TAB)), C(KC_TAB),  XXXXXXX,            XXXXXXX,   KC_7,   KC_8,   KC_9,   KC_MINS,  _______,
...
[_NAVI] = LAYOUT(
  ...
  _______,_______, _______,_______,_______,_______,                       KC_PGUP, KC_HOME, KC_UP, KC_END,  KC_INS, KC_F12,
  _______,_______,_______,_______,_______,_______,   _______, _______,  KC_PGDN, KC_LEFT, KC_DOWN,  KC_RGHT,  KC_DEL,  _______,
