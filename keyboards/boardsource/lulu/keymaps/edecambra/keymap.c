 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LCTL,  KC_Z,MT(MOD_LGUI,KC_X),KC_C,  KC_V,KC_B,  KC_MUTE,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RCTL,
...
[_NAVI] = LAYOUT(
  ...
  _______,   _______,   _______,   _______,  _______,  _______,   RGB_TOG, _______,  KC_PGDN, KC_LEFT, KC_DOWN,  KC_RGHT,  KC_DEL,  _______,
